            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 offset-md-2 text-center">
                        ...
                        <button class="btn btn-warning btn-block" data-toggle="modal" data-target="#more-detail" id="detail" style="margin: .5rem;"> <font-awesome-icon :icon="['fas', 'plus']" /> Detalhes</button>
...
<script>
    import VueDenuncia from '@/components/VueDenuncia.vue'
    import VueRelated from '@/components/VueRelated.vue'
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ax.get("p/" + this.$route.params.perid + "/")
                    .then(response => [
